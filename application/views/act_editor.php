...
<div class="admin_content fr">
    <h1>添加活动</h1>
    <div class="edit">
    	<form name="form1" action="<?php echo site_url('admin/act_edited'); ?>" method="post" enctype="multipart/form-data" onsubmit="return check()">
		<?php foreach($activity as $row): ?>
           ...
           <textarea class="ckeditor" name="intro_editor" rows="15" >
            ...
            <p> 每人限选
				...
				<input type="text" class="text" name="chance" onkeyup="this.value=this.value.replace(/\D/g,'')" value="<?php echo $row->chance; ?>" 
